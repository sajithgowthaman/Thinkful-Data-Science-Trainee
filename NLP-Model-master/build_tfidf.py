...
def buildingTFIDF(db_path, out_dir):
    args = {'tokenizer': 'corenlp', 'hash_size': int(math.pow(2, 24)), 'ngram': 2, 'num_workers': None}

    logging.info('Counting words...')
    count_matrix, doc_dict = get_count_matrix(args, 'sqlite', {'db_path': db_path})
    ...
    basename += ('-tfidf-ngram=%d-hash=%d-tokenizer=%s' % (2, int(math.pow(2, 24)), 'corenlp'))
